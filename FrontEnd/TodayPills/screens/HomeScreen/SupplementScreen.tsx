...
export default function SupplementScreen({ navigation, route }: any) {
  ...
  const aiSetting = async () => {
    ...
    if (
      answerSheet.lack.includes('채소') ||
      answerSheet.lack.includes('과일')
    ) {
      if (pill.category === '철분') {
        Ai.push(['철분', 0]);
      }
    ...
    if (
      answerSheet.lack.includes('생선') ||
      answerSheet.lack.includes('육류')
    ) {
      if (pill.category === '비타민 D') {
        Ai.push(['비타민 D', 0]);
      }
        ...
        {isLoading ? (
          <View style={styles.container}>
            <View style={styles.gobackcontainer}>
              <GoBackBtn onPress={() => navigation.goBack()} size={33} />
            </View>
            <View style={styles.titlecontainer}>
              <Text style={styles.title}>{pill.supplementName}</Text>
            </View>
            <ScrollView>
              <View style={styles.imagecontainer}>
                <Image source={{ uri: pill.image }} style={styles.image} />
                <Pressable
                  style={styles.navercontainer}
                  onPress={() => naverSearch()}
                >
                  <Text style={styles.navertext}>네이버</Text>
                  <Text style={styles.navertext}>검색</Text>
                  <Entypo
                ...
                >
                  ...
                  <Image
                    ...
                    style={styles.like}
                  />
                  <Text style={styles.likecount}>{likeCnt}</Text>
                </Pressable>
              </View>
              <View style={styles.textcontainer}>
                <View style={styles.flexrow}>
                  <View style={styles.headcontainer}>
                    <View style={styles.head}>
                      <Text style={styles.headtext}>카테고리</Text>
                    </View>
                  </View>
                  <View style={styles.contentcontainer}>
                    <View style={styles.content}>
                      <Text style={styles.contenttext}>{pill.category}</Text>
                    </View>
                  </View>
                </View>
                <View style={styles.flexrow}>
                  <View style={styles.headcontainer}>
                    <View style={styles.head}>
                      <Text style={styles.headtext}>제조사</Text>
                    </View>
                  </View>
                  <View style={styles.contentcontainer}>
                    <View style={styles.content}>
                ...
                <View style={styles.flexrow}>
                  <View style={styles.headcontainer}>
                    ...
                    >
                      <Text style={styles.headtext}>전성분</Text>
                    </Pressable>
                  </View>
                  <View style={styles.contentcontainer}>
                    <Pressable
                ...
                <View style={styles.flexrow}>
                  <View style={styles.headcontainer}>
                    <View style={styles.ingredienthead}>
                      <Text style={styles.headtext}>효능</Text>
                    </View>
                  </View>
                  <View style={styles.contentcontainer}>
              ...
              <View style={styles.flexrow}>
                <View style={styles.headcontainer}>
                  <View style={styles.head}>
                    <Text style={styles.headtext}>추천 복용 시간</Text>
                  </View>
                </View>
                <View style={styles.contentcontainer}>
                  <View style={styles.content}>
              ...
              <View style={styles.flexrow}>
                <View style={styles.headcontainer}>
                  <View style={styles.head}>
                    <Text style={styles.headtext}>총량</Text>
                  </View>
                </View>
                <View style={styles.contentcontainer}>
                  <View style={styles.content}>
              ...
              <View style={styles.flexrow}>
                <View style={styles.headcontainer}>
                  <View style={styles.head}>
                    <Text style={styles.headtext}>1회 섭취량</Text>
                  </View>
                </View>
                <View style={styles.contentcontainer}>
                  <View style={styles.content}>
              ...
              <View style={styles.flexrow}>
                <View style={styles.headcontainer}>
                  <View style={styles.head}>
                    <Text style={styles.headtext}>제형</Text>
                  </View>
                </View>
                <View style={styles.contentcontainer}>
                  <View style={styles.content}>
              ...
              <View style={styles.flexrow}>
                <View style={styles.headcontainer}>
                  <View style={styles.ingredienthead}>
                    <Text style={styles.headtext}>주의사항</Text>
                  </View>
                </View>
                <View style={styles.contentcontainer}>
                  <View style={styles.ingredientcontent}>
                    <Text style={styles.contenttext}>{pill.caution}</Text>
                  </View>
                </View>
              </View>
