...
import com.todaypill.repository.IronRepository;
...
public class IronService {
	...
	public IronService(SupplementRepository supplementRepository, IronRepository ironRepository) {
		super();
		this.supplementRepository = supplementRepository;
		this.ironRepository = ironRepository;
	}

	public void addIron() throws IOException, InterruptedException {
		...
		List<Iron> list = ironRepository.findAll();
		for (Iron m : list) {
