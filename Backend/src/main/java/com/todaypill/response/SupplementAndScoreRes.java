...
public class SupplementAndScoreRes extends Supplement {
    ...
    public SupplementAndScoreRes(Integer supplementId, String category, String supplementName, Double price, String brand, String image, String ingredients, Double bioavailability, Double laxative, Double kidneyDisease, Integer consumerLabScore, String additionalEfficacy, String note, String amount, String requiredCount, String formula, Integer like, Boolean sustainedRelease, String pillSize, String bestTime, Double score) {
        super(supplementId, category, supplementName, price, brand, image, ingredients, bioavailability, laxative, kidneyDisease, consumerLabScore, additionalEfficacy, note, amount, requiredCount, formula, like, sustainedRelease, pillSize, bestTime);
        this.score = score;
    }
