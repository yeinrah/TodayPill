...
import com.todaypill.db.entity.VitaminC;
import com.todaypill.repository.SupplementRepository;
import com.todaypill.repository.VitaminCRepository;

@Service
public class VitaminCService {
	@Autowired
	private SupplementRepository supplementRepository;

	@Autowired
	private VitaminCRepository vitaminCRepository;

	public VitaminCService(SupplementRepository supplementRepository, VitaminCRepository vitaminCRepository) {
		super();
		this.supplementRepository = supplementRepository;
		this.vitaminCRepository = vitaminCRepository;
	}

	public void addVitaminC() throws IOException, InterruptedException {
		...
		List<VitaminC> list = vitaminCRepository.findAll();
		for (VitaminC m : list) {
